  ...
  onLoad: function(options) {
    ...
    switch (type) {
      case '0':
        {
          this.setData({
            tempurl: app.globalData.BaseURL + 'martisClock/' + app.globalData.user.userID,
            title: "全部任务"
          })
        }
        break;
      case '1':
        {
          this.setData({
            tempurl: app.globalData.BaseURL + 'martisClockAlready/' + app.globalData.user.userID,
            title: "已完成"
          })
        }
        break;
      case '2':
        {
          this.setData({
            tempurl: app.globalData.BaseURL + 'martisClockPadding/' + app.globalData.user.userID,
            title: '进行中'
          })
        }
        break;
      case '3':
        {
          this.setData({
            tempurl: app.globalData.BaseURL + 'martisClockAlert/' + app.globalData.user.userID,
            title: '进行中'
          })
        }
        break;
